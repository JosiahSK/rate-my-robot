    ...
    <div className="min-h-screen pt-24 pb-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
          ...
          <Link to="/rate" className="btn-primary text-sm flex-shrink-0" id="gallery-rate-btn">
            + Rate Your Robot
          </Link>
        </div>
            ...
            {entries.slice(0, 3).map((e, i) => (
              <div
                ...
                className={`glass-card p-6 text-center border-2 ${
                  i === 0 ? 'border-yellow-500/60 bg-yellow-500/5 shadow-[0_0_30px_rgba(234,179,8,0.15)]' :
        ...
        {loading ? (
          ...
          <div className="glass-card p-10 text-center">
            ...
            <button onClick={() => setSortBy(sortBy)} className="btn-secondary text-sm mt-3">Retry</button>
          </div>
        ) : entries.length === 0 ? (
